...
const buttonConfig = {
    "tasks": { rewardEnabled: true, penaltyEnabled: true, displayFunc: displayTasks, sideBtn: tasksBtn },
    "missions": { rewardEnabled: true, penaltyEnabled: false, displayFunc: displayMissions, sideBtn: missionsBtn },
    "offenses": { rewardEnabled: false, penaltyEnabled: true, displayFunc: displayOffenses, sideBtn: offensesBtn },
